...
#   - Registro de logs.
# v1.3.3 2024-07-31 às 02h06, Marcos Aurélio:
...
$Install_Microsoft_Office_2019_to_2021 = $urlsData.OfficeSoftware[2] # Acessa a URL do pacote
...
if (Test-Path $directory) {
    ...
    $downloadUrl = $Install_Microsoft_Office_2019_to_2021

...
:: Opções do Menu
set "menu[1.0]=Voltar..."
set "menu[1.1]=Atualizar QuickWindows"
set "menu[1.2]=Deletar QuickWindows"
set "menu[1.3]=Recarregar QuickWindows"

set "default=0"

:menu
powershell -noprofile "iex (gc \"%~f0\" | out-string)"
if %ERRORLEVEL% equ "1.0" (
    cls
    cd ..
    cd ..

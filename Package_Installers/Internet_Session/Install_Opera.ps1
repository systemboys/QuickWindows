...
# v1.2.3 2024-07-28 às 00h09, Marcos Aurélio:
#   - Registro de logs.
# v1.3.3 2024-07-31 às 01h06, Marcos Aurélio:
...
$Install_Opera = $urlsData.Internet[7] # Acessa a URL do pacote

...
Write-Host "0 = Sair                                                                        [ ok ]" -ForegroundColor Red
Write-Host "1 = Menu QuickWindows...                                                        [ ok ]" -ForegroundColor Red
...
Write-Host "2 = Windows...                                                                  [ ok ]" -ForegroundColor Red
...
Write-Host "        269 = Mais...                                                           [ ok ]" -ForegroundColor Red
...
Write-Host "3 = Internet...                                                                 [ ok ]" -ForegroundColor Red
Write-Host "    31 = Acesso Remoto...                                                       [ ok ]" -ForegroundColor Red
...
Write-Host "    39 = Downloads...                                                           [ ok ]" -ForegroundColor Red
...
Write-Host "4 = Redes...                                                                    [ ok ]" -ForegroundColor Red
...
Write-Host "6 = Utilitarios para Windows...                                                 [ ok ]" -ForegroundColor Red
Write-Host "    61 = Instalar Revo Uninstaller                                              [ ok ]" -ForegroundColor Green
Write-Host "    62 = Compactadores...                                                       [ ok ]" -ForegroundColor Red
...
Write-Host "    67 = Software de gerenciamento de particaes...                              [ ok ]" -ForegroundColor Red
...
Write-Host "    68 = Ferramentas de restauracao do sistema...                               [ ok ]" -ForegroundColor Red
...
Write-Host "    69 = Mais...                                                                [ ok ]" -ForegroundColor Red
...
Write-Host "        699 = Mais...                                                           [ ok ]" -ForegroundColor Red
...
Write-Host "7 = Softwares para Escritorio...                                                [ ok ]" -ForegroundColor Red
...
Write-Host "8 = Sistemas Operacionais Microsoft...                                          [ ok ]" -ForegroundColor Red

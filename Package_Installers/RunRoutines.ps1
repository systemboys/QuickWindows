...
$Files = @{
    ...
    '3'    = ''
    '31'   = ''
    '311'  = PowerShell.exe -NoProfile -ExecutionPolicy Bypass -Command "& {Start-Process PowerShell.exe -ArgumentList '-NoProfile -ExecutionPolicy Bypass -File ""%~dp0Package_Installers\Internet_Session\Install_AnyDesk.ps1""' -Verb RunAs}"
    '312'  = PowerShell.exe -NoProfile -ExecutionPolicy Bypass -Command "& {Start-Process PowerShell.exe -ArgumentList '-NoProfile -ExecutionPolicy Bypass -File ""%~dp0Package_Installers\Internet_Session\Install_RustDesk.ps1""' -Verb RunAs}"
    '313'  = ''
    '32'   = ''
    '33'   = ''
    '34'   = ''
    ...
    '38'   = ''
    '39'   = ''
    '391'  = PowerShell.exe -NoProfile -ExecutionPolicy Bypass -Command "& {Start-Process PowerShell.exe -ArgumentList '-NoProfile -ExecutionPolicy Bypass -File ""%~dp0Package_Installers\Internet_Session\Install_Transmission.ps1""' -Verb RunAs}"
    '392'  = ''
    '393'  = ''
    '4'    = ''
    '41'   = ''

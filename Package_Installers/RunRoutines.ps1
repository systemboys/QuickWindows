...
$Files = @{
    ...
    # "6" = "" # Utilitários para Windows…
        "61" = "$env:TEMP\QuickWindows\Package_Installers\UtilitiesForWindows\.ps1" # Instalar Revo Uninstaller
        # "62" = "" # Compactadores…
        ...
        # "69" = "" # Mais…
            ...
            "696" = "$env:TEMP\QuickWindows\Package_Installers\UtilitiesForWindows\Run_CrystalDiskInfo_Portable.ps1" # Crystal Disk Info Portable

...
Write-Host "## Rotinas" -ForegroundColor Green
Write-Host "├─ 0 = Sair" -ForegroundColor Red
Write-Host "├─ 1 = Menu QuickWindows..." -ForegroundColor Red
Write-Host "│  ├─ 11 = Atualizar QuickWindows" -ForegroundColor Green
Write-Host "│  ├─ 12 = Deletar QuickWindows" -ForegroundColor Green
Write-Host "│  └─ 13 = Recarregar QuickWindows" -ForegroundColor Green
Write-Host "├─ 2 = Windows..." -ForegroundColor Red
Write-Host "│  ├─ 21 = Desligar o Windows" -ForegroundColor Green
Write-Host "│  ├─ 22 = Reiniciar o Windows" -ForegroundColor Green
Write-Host "│  ├─ 23 = Agendar desligamento do Windows" -ForegroundColor Green
Write-Host "│  ├─ 24 = Atualizar Windows e Softwares" -ForegroundColor Green
Write-Host "│  ├─ 25 = Atualizar o PowerShell" -ForegroundColor Green
Write-Host "│  ├─ 26 = Acesso rapido à Configurações..." -ForegroundColor Red
Write-Host "│  │  ├─ 261 = Painel de Controle (Control)" -ForegroundColor Green
Write-Host "│  │  ├─ 262 = Editor de Registro (RegEdit)" -ForegroundColor Green
Write-Host "│  │  ├─ 263 = Configuracaes do Sistema (MSConfig)" -ForegroundColor Green
Write-Host "│  │  ├─ 264 = Servicas (Services.msc)" -ForegroundColor Green
Write-Host "│  │  ├─ 265 = Gerenciador de Dispositivos (DevMgmt.msc)" -ForegroundColor Green
Write-Host "│  │  ├─ 266 = Gerenciamento de Discos (DiskMgmt.msc)" -ForegroundColor Green
Write-Host "│  │  ├─ 267 = Explorador de arquivos do Windows" -ForegroundColor Green
Write-Host "│  │  ├─ 268 = Configuracaes - Tela (tipo, ajustes de resolucao de tela)" -ForegroundColor Green
Write-Host "│  │  └─ 269 = Mais..." -ForegroundColor Red
Write-Host "│  │     ├─ 2691 = Configuracaes avancadas do sistema (Propriedades do Sistema)" -ForegroundColor Green
Write-Host "│  │     ├─ 2692 = Editar Configuracaes do Plano" -ForegroundColor Green
Write-Host "│  │     ├─ 2693 = Sobre o Windows (WinVer)" -ForegroundColor Green
Write-Host "│  │     ├─ 2694 = Gerenciar arquivos e pastas" -ForegroundColor Green
Write-Host "│  │     ├─ 2695 = Configuracaes do Windows" -ForegroundColor Green
Write-Host "│  │     ├─ 2696 = Gerenciador de Tarefas do Windows" -ForegroundColor Green
Write-Host "│  │     ├─ 2697 = Opcaes de pastas" -ForegroundColor Green
Write-Host "│  │     └─ 2698 = Obtendo Informacaes do Sistema com PowerShell" -ForegroundColor Green
Write-Host "│  └─ 27 = Criar atalhos para 'Desligar e Reiniciar'" -ForegroundColor Green
Write-Host "├─ 3 = Internet..." -ForegroundColor Red
Write-Host "│  ├─ 31 = Acesso Remoto..." -ForegroundColor Red
Write-Host "│  │  ├─ 311 = AnyDesk" -ForegroundColor Green
Write-Host "│  │  ├─ 312 = Reset AnyDesk" -ForegroundColor Green
Write-Host "│  │  ├─ 313 = RustDesk" -ForegroundColor Green
Write-Host "│  │  └─ 314 = HopToDesk" -ForegroundColor Green
Write-Host "│  ├─ 32 = Navegador Microsoft Edge" -ForegroundColor Green
Write-Host "│  ├─ 33 = Navegador Google Chrome" -ForegroundColor Green
Write-Host "│  ├─ 34 = Navegador Google Earth Pro" -ForegroundColor Green
Write-Host "│  ├─ 35 = Comunicador Skype" -ForegroundColor Green
Write-Host "│  ├─ 36 = Navegador Opera" -ForegroundColor Green
Write-Host "│  ├─ 37 = Navegador Mozilla Firefox" -ForegroundColor Green
Write-Host "│  ├─ 38 = Visualizador Real VNC Viewer" -ForegroundColor Green
Write-Host "│  └─ 39 = Downloads..." -ForegroundColor Red
Write-Host "│     ├─ 391 = Transmission" -ForegroundColor Green
Write-Host "│     ├─ 392 = IDM - Internet Download Manager" -ForegroundColor Green
Write-Host "│     └─ 393 = Baixar URL" -ForegroundColor Green
Write-Host "├─ 4 = Redes..." -ForegroundColor Red
Write-Host "│  ├─ 41 = Obter IP publico" -ForegroundColor Green
Write-Host "│  ├─ 42 = Obter IP local" -ForegroundColor Green
Write-Host "│  └─ 43 = Obter IPs de uma determinada rota" -ForegroundColor Green
Write-Host "├─ 5 = Execucao de Comandos no PowerShell" -ForegroundColor Red
Write-Host "├─ 6 = Utilitarios para Windows..." -ForegroundColor Red
Write-Host "│  ├─ 61 = Instalar Revo Uninstaller" -ForegroundColor Green
Write-Host "│  ├─ 62 = Compactadores..." -ForegroundColor Red
Write-Host "│  │  ├─ 621 = WinRAR" -ForegroundColor Green
Write-Host "│  │  ├─ 622 = WinZip" -ForegroundColor Green
Write-Host "│  │  └─ 623 = 7-Zip" -ForegroundColor Green
Write-Host "│  ├─ 63 = Leitores de PDF..." -ForegroundColor Red
Write-Host "│  │  ├─ 631 = Acrobat Reader DC" -ForegroundColor Green
Write-Host "│  │  └─ 632 = Foxit PDF Reader" -ForegroundColor Green
Write-Host "│  ├─ 64 = Players Multimidia..." -ForegroundColor Red
Write-Host "│  │  ├─ 640 = Voltar..." -ForegroundColor Green
Write-Host "│  │  └─ 641 = VLC Media Player" -ForegroundColor Green
Write-Host "│  ├─ 65 = Software de congelamento do sistema..." -ForegroundColor Red
Write-Host "│  │  ├─ 651 = Deep Freeze Standard" -ForegroundColor Green
Write-Host "│  │  └─ 652 = Shadow Defender" -ForegroundColor Green
Write-Host "│  ├─ 66 = Backup e Restauracao..." -ForegroundColor Red
Write-Host "│  │  ├─ 661 = Compressao de arquivos, PowerShell Backup Automatico (.zip)" -ForegroundColor Green
Write-Host "│  │  └─ 662 = Cobian Backup" -ForegroundColor Green
Write-Host "│  ├─ 67 = Software de gerenciamento de particaes..." -ForegroundColor Red
Write-Host "│  │  ├─ 671 = MiniTool Partition Wizard v12 Installation" -ForegroundColor Green
Write-Host "│  │  ├─ 672 = MiniTool Partition Wizard v12 32bit portable" -ForegroundColor Green
Write-Host "│  │  └─ 673 = MiniTool Partition Wizard v12 64bit portable" -ForegroundColor Green
Write-Host "│  ├─ 68 = Ferramentas de restauracao do sistema..." -ForegroundColor Red
Write-Host "│  │  ├─ 681 = WinToHDD" -ForegroundColor Green
Write-Host "│  │  ├─ 682 = Hasleo WinToHDD Free" -ForegroundColor Green
Write-Host "│  │  ├─ 683 = Rufus" -ForegroundColor Green
Write-Host "│  │  └─ 684 = DriverMax" -ForegroundColor Green
Write-Host "│  └─ 69 = Mais..." -ForegroundColor Red
Write-Host "│     ├─ 691 = Limpar Spooler de Impressao" -ForegroundColor Green
Write-Host "│     ├─ 692 = Limpar Arquivos Temporarios" -ForegroundColor Green
Write-Host "│     ├─ 693 = Driver Booster Free" -ForegroundColor Green
Write-Host "│     ├─ 694 = CPU-Z" -ForegroundColor Green
Write-Host "│     ├─ 695 = CPU-Z Portable" -ForegroundColor Green
Write-Host "│     ├─ 696 = Crystal Disk Info" -ForegroundColor Green
Write-Host "│     ├─ 697 = Crystal Disk Info Portable" -ForegroundColor Green
Write-Host "│     ├─ 698 = Windows Update Activation" -ForegroundColor Green
Write-Host "│     └─ 699 = Mais..." -ForegroundColor Red
Write-Host "│        ├─ 6991 = Revo Uninstaller Portable" -ForegroundColor Green
Write-Host "│        ├─ 6992 = Battery Report" -ForegroundColor Green
Write-Host "│        ├─ 6993 = SiberiaProg-CH341A" -ForegroundColor Green
Write-Host "│        └─ 6994 = SiberiaProg-CH341A Portable" -ForegroundColor Green
Write-Host "├─ 7 = Softwares para Escritório..." -ForegroundColor Red
Write-Host "│  ├─ 71 = Microsoft Office 2016 a 2019" -ForegroundColor Green
Write-Host "│  ├─ 72 = Microsoft Office 2019 a 2021" -ForegroundColor Green
Write-Host "│  ├─ 73 = Microsoft Office 365" -ForegroundColor Green
Write-Host "│  └─ 74 = Criar atalhos para Apps do Office 2021" -ForegroundColor Green
Write-Host "└─ 8 = Sistemas Operacionais Microsoft..." -ForegroundColor Red
Write-Host "   ├─ 81 = Windows 7, todas as versões" -ForegroundColor Green
Write-Host "   ├─ 82 = Windows 7 Lite" -ForegroundColor Green
Write-Host "   ├─ 83 = Windows 10 Pro 32bits" -ForegroundColor Green
Write-Host "   ├─ 84 = Windows 10 Pro 64bits" -ForegroundColor Green
Write-Host "   ├─ 85 = Windows 10 1909 PRO MSDN LITE Build" -ForegroundColor Green
Write-Host "   ├─ 86 = Windows 11 Pro" -ForegroundColor Green
Write-Host "   └─ 87 = Windows Server 2022" -ForegroundColor Green

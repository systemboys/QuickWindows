...
Write-Host "        261 = Painel de Controle (Control)                                              [  ok  ]" -ForegroundColor Red
Write-Host "        262 = Editor de Registro (RegEdit)                                              [  ok  ]" -ForegroundColor Red
Write-Host "        263 = Configuracaes do Sistema (MSConfig)                                       [  ok  ]" -ForegroundColor Red
Write-Host "        264 = Servicas (Services.msc)                                                   [  ok  ]" -ForegroundColor Red
Write-Host "        265 = Gerenciador de Dispositivos (DevMgmt.msc)                                 [  ok  ]" -ForegroundColor Red
Write-Host "        266 = Gerenciamento de Discos (DiskMgmt.msc)                                    [  ok  ]" -ForegroundColor Red
Write-Host "        267 = Explorador de arquivos do Windows                                         [  ok  ]" -ForegroundColor Red
Write-Host "        268 = Configuracaes - Tela (tipo, ajustes de resolucao de tela)                 [  ok  ]" -ForegroundColor Red
Write-Host "        269 = Mais...                                                                   [ null ]" -ForegroundColor Red
Write-Host "            2691 = Configuracaes avancadas do sistema (Propriedades do Sistema)         [  ok  ]" -ForegroundColor Red
Write-Host "            2692 = Editar Configuracaes do Plano                                        [  ok  ]" -ForegroundColor Red
Write-Host "            2693 = Sobre o Windows (WinVer)                                             [  ok  ]" -ForegroundColor Red

...
$Files = @{
    ...
    '3'    = ''
    '31'   = ''
    '311'  = 'powershell -Command "$env:TEMP\QuickWindows\Package_Installers\Internet_Session\Install_AnyDesk.ps1"'
    '312'  = 'powershell -Command "$env:TEMP\QuickWindows\Package_Installers\Internet_Session\Install_RustDesk.ps1"'
    '313'  = ''
    '32'   = ''
    '33'   = ''
    '34'   = ''
    ...
    '38'   = ''
    '39'   = ''
    '391'  = 'powershell -Command "$env:TEMP\QuickWindows\Package_Installers\Internet_Session\Install_Transmission.ps1"'
    '392'  = ''
    '393'  = ''
    '4'    = ''
    '41'   = ''

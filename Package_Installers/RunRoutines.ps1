...
Write-Host "    26 = Acesso rapido à Configuracaes...                                       [ ok ]" -ForegroundColor Red
...
Write-Host "7 = Softwares para Escritorio..." -ForegroundColor Red
...
Write-Host "    81 = Windows 7, todas as versões                                            [ ok ]" -ForegroundColor Green

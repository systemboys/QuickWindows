...
if %ERRORLEVEL% equ 1 (
    ...
    PowerShell.exe -NoProfile -ExecutionPolicy Bypass -Command "& {iex ""%~dp0arquivo.ps1 1""}"
...
if %ERRORLEVEL% equ 2 (
    ...
    PowerShell.exe -NoProfile -ExecutionPolicy Bypass -Command "& {iex ""%~dp0arquivo.ps1 2""}"

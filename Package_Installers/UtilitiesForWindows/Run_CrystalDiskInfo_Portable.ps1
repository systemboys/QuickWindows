...
#   - Registro de logs.
# v1.3.2 2024-08-01 às 00h19, Marcos Aurélio:
...
$Run_CrystalDiskInfo_Portable = $urlsData.UtilitiesForWindows[21] # Acessa a URL do pacote
...
if (Test-Path $directory) {
    ...
    $downloadUrl = $Run_CrystalDiskInfo_Portable

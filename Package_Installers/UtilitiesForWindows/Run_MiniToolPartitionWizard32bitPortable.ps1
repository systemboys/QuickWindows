...
# v1.2.2 2024-07-28 às 01h49, Marcos Aurélio:
#   - Registro de logs.
# v1.3.2 2024-08-01 às 00h21, Marcos Aurélio:
...
$Run_MiniToolPartitionWizard32bitPortable = $urlsData.UtilitiesForWindows[22] # Acessa a URL do pacote
...
if (Test-Path $directory) {
    ...
    $downloadUrl = $Run_MiniToolPartitionWizard32bitPortable

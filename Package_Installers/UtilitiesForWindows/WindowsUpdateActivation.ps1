...
#   - Registro de logs.
# v1.3.2 2024-08-01 às 00h29, Marcos Aurélio:
...
$WindowsUpdateActivation = $urlsData.UtilitiesForWindows[27] # Acessa a URL do pacote
...
$downloadUrl = $WindowsUpdateActivation

...
#   - Registro de logs.
# v1.3.3 2024-08-01 às 00h07, Marcos Aurélio:
...
$Install_VLCMediaPlayer = $urlsData.UtilitiesForWindows[16] # Acessa a URL do pacote
...
if (Test-Path $directory) {
    ...
    $downloadUrl = $Install_VLCMediaPlayer

...
# v1.2.2 2024-07-28 às 01h28, Marcos Aurélio:
#   - Registro de logs.
# v1.3.2 2024-07-31 às 23h45, Marcos Aurélio:
...
$Install_CrystalDiskInfo = $urlsData.UtilitiesForWindows[5] # Acessa a URL do pacote
...
if (Test-Path $directory) {
    ...
    $downloadUrl = $Install_CrystalDiskInfo
